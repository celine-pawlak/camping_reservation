...
<footer>
    ...
    <section id=container-bottom>
        ...
        <section id="footerright">
            ...
            <p>"Le Sardine's Camp vous accueille au coeur de la Méditerranée dans un cadre idyllique. Vous serez plongés
                entre la mer, les calanques, les massifs de pins.
