...
<body>
    ...
    <main>
        ...
        <section class="admin_general">
            <br/><h1>MODIFICATION DES TARIFS, EMPLACEMENTS ET OPTIONS</h1>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="user_modify_button" href="admin.php?modifier_lieu=<?php echo $place['nom_lieu']  ?>">EDITER</a>
                            </td>
                            <td>
                                <form method="post" action="">
                ...
                <?php 
                    if(isset($_GET['modifier_type']))
                    {
                        ...
                        <form class="form_admin" method="post" action="">
                            ...
                            <input type="hidden" name="type_id_hidden2" value="<?php echo $type['id_type_emplacement']  ?>"><br/><br/>
            ...
            <section class="admin_table admin_gestion">
                ...
                if(isset($_GET['modifier_option']))
                {
                    ...
                    <form class="form_admin" method="post" action="">
                        ...
                        <input type="hidden" name="option_id_hidden2" value="<?php echo $option['id_option']  ?>"><br/><br/>
